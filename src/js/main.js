...
window.addEventListener("click", e => {
  if (e.target.closest(".header-hamburger__wrapper")) {
    ...
    header.classList.contains("notactive") && header.classList.remove("notactive");
  } else if (e.target != header && !e.target.classList.contains("navigation__section") && !e.target.classList.contains("navigation__input") && !e.target.classList.contains("navigation___item") && !e.target.classList.contains("navigation__list") && !e.target.classList.contains("header-wrapper") ) {
